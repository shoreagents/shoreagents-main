    ...
    <>
      ...
      <div className="hidden lg:block fixed top-20 right-0 z-50 group">
        <div className="flex flex-col space-y-3 pr-2 transition-all duration-300 group-hover:-pr-10 hover:-mr-10">
          ...
          <div className="flex items-center transition-all duration-300 group-hover:translate-x-0 translate-x-37">
            <button 
              onClick={handlePhilippinesGotTalent}
              className="bg-lime-100 border border-lime-300 rounded-2xl px-6 py-5 shadow-[4px_4px_0px_#4d7c0f] min-w-[200px] h-16 flex items-center justify-start opacity-60 group-hover:opacity-100 transition-all duration-300 hover:bg-lime-200 hover:shadow-[6px_6px_0px_#4d7c0f] hover:scale-105 hover:-translate-y-1 cursor-pointer active:shadow-[2px_2px_0px_#4d7c0f] active:translate-y-0 active:scale-95"
            >
              <Star className="w-7 h-7 mr-3 text-lime-600 flex-shrink-0" />
          ...
          <div className="flex items-center transition-all duration-300 group-hover:translate-x-0 translate-x-37">
            <button 
              ...
              className="bg-lime-100 border border-lime-300 rounded-2xl px-6 py-5 shadow-[4px_4px_0px_#4d7c0f] min-w-[200px] h-16 flex items-center justify-start opacity-60 group-hover:opacity-100 transition-all duration-300 hover:bg-lime-200 hover:shadow-[6px_6px_0px_#4d7c0f] hover:scale-105 hover:-translate-y-1 cursor-pointer active:shadow-[2px_2px_0px_#4d7c0f] active:translate-y-0 active:scale-95"
            >
              <svg className="w-7 h-7 mr-3 text-lime-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 002 2v12a2 2 0 002 2z" />
              </svg>
              <div className="flex flex-col items-start justify-center h-full space-y-0 flex-grow">
                <span className="text-xs leading-none text-gray-700">BOOK</span>
                <span className="font-black text-xs leading-none text-gray-700">CONSULTATIONS!</span>
              </div>
            </button>
          </div>
        </div>
