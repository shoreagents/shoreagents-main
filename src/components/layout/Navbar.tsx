                ...
                <div className="p-3">
                  ...
                  <div className="relative group/story">
                    <div className="flex items-center justify-between w-full text-left px-3 py-2 text-gray-700 hover:text-lime-600 hover:bg-lime-50 rounded transition-colors duration-200 cursor-pointer">
                      ...
                      <ChevronDown className="h-4 w-4 group-hover/story:rotate-180 transition-transform duration-200" />
                    </div>
                    
                    {/* Our Story Submenu */}
                    <div className="absolute left-full top-0 ml-2 w-[600px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover/story:opacity-100 group-hover/story:visible transition-all duration-300">
                      <div className="p-6">
                        <h3 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-200 pb-2">Our Story</h3>
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-6">
                          <Link href="/about/our-team" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">Meet the people behind Shore Agents</p>
                          ...
                          <Link href="/about/stephen-atcheler" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Stephen Atcheler, CEO</h4>
                                <p className="text-sm text-gray-600 mt-1">Leadership and vision</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">CEO</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          ...
                          <Link href="/about/find-us-clark" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Find Us in Clark</h4>
                                <p className="text-sm text-gray-600 mt-1">Visit our office location</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">Location</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="space-y-2">
                            <Link href="/about/ballast-team" className="block text-sm text-gray-700 hover:text-lime-600 transition-colors duration-200 font-medium">
                              Ballast: 4 - 46 Team
                            </Link>
                          </div>
                        </div>
                  ...
                  <div className="relative group/results">
                    <div className="flex items-center justify-between w-full text-left px-3 py-2 text-gray-700 hover:text-lime-600 hover:bg-lime-50 rounded transition-colors duration-200 cursor-pointer">
                      ...
                      <ChevronDown className="h-4 w-4 group-hover/results:rotate-180 transition-transform duration-200" />
                    </div>
                    
                    {/* Proven Results Submenu */}
                    <div className="absolute left-full top-0 ml-2 w-[600px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover/results:opacity-100 group-hover/results:visible transition-all duration-300">
                      <div className="p-6">
                        <h3 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-200 pb-2">Proven Results</h3>
                        
                        {/* Case Studies Section */}
                        <div className="grid grid-cols-3 gap-4 mb-6">
                          <Link href="/about/gallery-group-partnership" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Gallery Group Partnership</h4>
                                <p className="text-sm text-gray-600 mt-1">Successful partnership showcase</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">Partnership</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          ...
                          <Link href="/about/gallery-group-partnership-2" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Gallery Group Partnership</h4>
                                <p className="text-sm text-gray-600 mt-1">Another successful partnership</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">Partnership</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <Link href="/about/jack-miller-savings" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Jack Miller: $40K Savings</h4>
                                <p className="text-sm text-gray-600 mt-1">Cost savings case study</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">Savings</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="space-y-2">
                            <Link href="/about/all-case-studies" className="block text-sm text-gray-700 hover:text-lime-600 transition-colors duration-200 font-medium">
                              All Case Studies
                            </Link>
                          </div>
                        </div>
                  ...
                  <div className="relative group/resources">
                    <div className="flex items-center justify-between w-full text-left px-3 py-2 text-gray-700 hover:text-lime-600 hover:bg-lime-50 rounded transition-colors duration-200 cursor-pointer">
                      ...
                      <ChevronDown className="h-4 w-4 group-hover/resources:rotate-180 transition-transform duration-200" />
                    </div>
                    
                    {/* Resources Submenu */}
                    <div className="absolute left-full top-0 ml-2 w-[600px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover/resources:opacity-100 group-hover/resources:visible transition-all duration-300">
                      <div className="p-6">
                        <h3 className="text-lg font-bold text-gray-900 mb-4 border-b border-gray-200 pb-2">Resources</h3>
                        
                        {/* Resources Section */}
                        <div className="grid grid-cols-3 gap-4 mb-6">
                          <Link href="/about/complete-service-guide" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Complete Service Guide</h4>
                                <p className="text-sm text-gray-600 mt-1">Comprehensive service overview</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">Guide</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          ...
                          <Link href="/about/blog-articles" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Blog & Articles</h4>
                                <p className="text-sm text-gray-600 mt-1">Latest insights and updates</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">Blog</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          ...
                          <Link href="/about/pricing-calculator" className="block p-4 bg-lime-50 rounded-lg hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-semibold text-gray-900 group-hover:text-lime-600 transition-colors duration-200">Pricing Calculator</h4>
                                <p className="text-sm text-gray-600 mt-1">Calculate your costs</p>
                                <span className="inline-block mt-2 px-2 py-1 bg-lime-100 text-lime-700 text-xs font-medium rounded">Calculator</span>
                              </div>
                              <div className="text-lime-600 group-hover:translate-x-1 transition-transform duration-200">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div className="space-y-2">
                            <Link href="/about/our-agents-demos" className="block text-sm text-gray-700 hover:text-lime-600 transition-colors duration-200 font-medium">
                              Our Agents Demos
                            </Link>
                          </div>
                        </div>
                ...
                <div className="p-2">
                  ...
                  <div className="relative group/story">
                    ...
                    <div className="absolute left-full top-0 ml-1 w-[400px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover/story:opacity-100 group-hover/story:visible transition-all duration-300">
                      <div className="p-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="space-y-1">
                            <Link href="/about/ballast-team" className="block text-xs text-gray-700 hover:text-lime-600 transition-colors duration-200 font-medium">
                              Ballast: 4 - 46 Team
                            </Link>
                          </div>
                        </div>
                  ...
                  <div className="relative group/results">
                    ...
                    <div className="absolute left-full top-0 ml-1 w-[400px] bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover/results:opacity-100 group-hover/results:visible transition-all duration-300">
                      <div className="p-4">
                        <h3 className="text-base font-bold text-gray-900 mb-3 border-b border-gray-200 pb-1">Proven Results</h3>
                        
                        {/* Case Studies Section */}
                        <div className="grid grid-cols-1 gap-2 mb-3">
                          <Link href="/about/gallery-group-partnership" className="block p-3 bg-lime-50 rounded hover:bg-lime-100 transition-colors duration-200 group">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-xs text-gray-600 mt-1">Successful partnership showcase</p>
