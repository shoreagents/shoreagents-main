      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">{employee.user.full_name}</h2>
                ...
                <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-medium text-green-700">{formatSalary(employee.workStatus.currentSalary)}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Salary Goal:</span>
                      <span className="font-medium text-blue-700">{formatSalary(employee.workStatus.salaryGoal)}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Notice Period:</span>
                      <span className="font-medium text-orange-700">{employee.workStatus.noticePeriod} days</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-600">Employment Type:</span>
                      <span className="font-medium text-gray-900 capitalize">{employee.workStatus.employmentType}</span>
                    </div>
                    <div className="flex items-center justify-between">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    className="w-full flex items-center justify-center space-x-2"
                    onClick={() => {
                      const message = `Hi ${employee.user.full_name}, I'm interested in discussing potential opportunities with you.`;
